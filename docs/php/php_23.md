...
![实验楼](img/73ba6811a5ef422084ed2c5bc4d64c30.jpg)
...
![此处输入图片的描述](img/2cda5fac05c1eb0677552149d5edb6c5.jpg)
...
![实验楼](img/feb17f977dc1b4cb0be5f981d6ad96cd.jpg)

还会问我们用来管理数据库的话是否要一起配置了，若是需要配置则按着提示输入数据库密码。

![实验楼](img/0e79bb9ccbdb1612fd51939042868213.jpg)
...
![实验楼](img/84c536f0f4d89968461eaa05f59f47ff.jpg)

![实验楼](img/1aa3bffcdddef5e422db9a548919ab7c.jpg)
...
![实验楼](img/2fe6770d4779228ab0fc9a1f5cd0f0db.jpg)

若是成功的配置，我们在浏览器的地址栏中输入 `localhost/wordpress` 即可得到这样的界面。

![实验楼](img/3d0bbcb793c1204fc0d21027bbdeaa8b.jpg)

若是在配置文件中的数据库信息填写错误那么将会得到这样的界面。

![实验楼](img/c5e2b4242fae021663cc571f4c353871.jpg)

按照指导完成用户的注册，之后我们便可登陆，得到这样的页面，我们便可以开始我们的博文创作了。

![实验楼](img/b98149cf0daf9f864e74b791ef68a11e.jpg)

![实验楼](img/2d27470aa65fdbef4554b02f30623373.jpg)

![实验楼](img/e2610d9cf3c4474477311fd87a3e0a4a.jpg)
