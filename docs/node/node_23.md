...
![](https://raw.githubusercontent.com/alsotang/node-lessons/master/lesson12/1.png)
...
![](https://raw.githubusercontent.com/alsotang/node-lessons/master/lesson12/2.png)

接着，往 heroku 这个远端地址推送我们的 master 分支：

![](https://raw.githubusercontent.com/alsotang/node-lessons/master/lesson12/3.png)

heroku 会自动检测出我们是 node.js 程序，并安装依赖，然后按照 Procfile 进行启动。

push 完成后，在命令键入 `heroku open`，则 heroku 会自动打开浏览器带我们去到相应的网址：

![](https://raw.githubusercontent.com/alsotang/node-lessons/master/lesson12/4.png)
