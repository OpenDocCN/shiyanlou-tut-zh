...
![实验楼](img/0ce8d0504ae6e11aecb371f76a270a81.jpg)
...
![此处输入图片的描述](img/5c2d28d4eeb9bfb6ba98f07a50bcd834.jpg)
...
![实验楼](img/de352720dce29cb4aa5a5384a830a933.jpg)

还会问我们用来管理数据库的话是否要一起配置了，若是需要配置则按着提示输入数据库密码。

![实验楼](img/c3a4f0eac8cfe3e0bc3a2bcd18b32504.jpg)
...
![实验楼](img/eaae2145809ab988e07e0da9c4c4bc4a.jpg)

![实验楼](img/76bfc33b9651026faf12907a6561834d.jpg)
...
![实验楼](img/7f541fbf63ceb726c41934636e60ceb9.jpg)

若是成功的配置，我们在浏览器的地址栏中输入 `localhost/wordpress` 即可得到这样的界面。

![实验楼](img/29eccd77599b587fc12f4e937de65fd2.jpg)

若是在配置文件中的数据库信息填写错误那么将会得到这样的界面。

![实验楼](img/a27e170501d35c090bf9b3da9380a51e.jpg)

按照指导完成用户的注册，之后我们便可登陆，得到这样的页面，我们便可以开始我们的博文创作了。

![实验楼](img/44a18c21f7f8c630ca4cc37608c8c90b.jpg)

![实验楼](img/786f24dd6785528295da3402e4bc2204.jpg)

![实验楼](img/12c033790713127b3c01a32654299da0.jpg)
